...
export default function ClientDashboardLayout({ children, user }) {
  ...
  const getPageTitle = (path) => {
    if (path === '/dashboard') return 'Client Portal / Overview';
    if (path.startsWith('/dashboard/workflows')) return 'Client Portal / Workflows';
    if (path.startsWith('/dashboard/connections')) return 'Client Portal / Connections';
    if (path.startsWith('/dashboard/settings')) return 'Client Portal / Settings';
    if (path.startsWith('/dashboard/calendars')) return 'Client Portal / Calendars';
